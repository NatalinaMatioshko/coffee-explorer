...
//   // Запобігаємо закриттю при кліку на саму модалку
//   const handleContentClick = (e: React.MouseEvent) => {
//     e.stopPropagation();
//   };
...
//       {/* Modal Content */}
//       <div
//         className="relative w-full max-w-md overflow-hidden rounded-2xl bg-[#fefbf3] p-8 shadow-2xl animate-slide-in"
//         onClick={handleContentClick}
//       >
//         {/* Close Button */}
//         <button
...
//           <button
//             type="submit"
//             className="mt-4 rounded-xl bg-[#4f2d20] py-3 font-semibold text-[#fefbf3] transition-transform hover:scale-[1.02] active:scale-95"
//           >
